---
title: "Getting started with the Documentation of Doom.is"
keywords: sample homepage
tags: [getting_started]
sidebar: mydoc_sidebar
permalink: index.html
summary: These brief instructions are leftovers from the template we're using, please stand by.
---

{% include note.html content="In progress..." %}
